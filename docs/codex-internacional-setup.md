...
- `skills/writing-skills/` (só necessário se você for author de novas skills)
- `skills/using-superpowers/` (documentação introdutória)
...
4. `requesting-code-review` + `agents/code-reviewer.md` → revisar
