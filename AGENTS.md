# AGENTS.md — Codex Professional Operating System

Este projeto usa um fluxo profissional com Codex focado em previsibilidade, segurança e entrega contínua.

## Estrutura oficial (organizada)

- `AGENTS.md` fica na **raiz**.
- Todo restante do kit fica em `.codex-kit/`:
  - `.codex-kit/agents/`
  - `.codex-kit/skills/`
  - `.codex-kit/templates/`
